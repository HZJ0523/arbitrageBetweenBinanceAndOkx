...
const FundingRateTable = lazy(() => import('./components/FundingRateTable'));
const Settings = lazy(() => import('./components/Settings'));
const LogPanel = lazy(() => import('./components/LogPanel'));
const AccountInfoPanel = lazy(() => import('./components/AccountInfoPanel'));
const StartArbitragePanel = lazy(() => import('./components/StartArbitragePanel'));
            ...
            <div className="max-w-[1800px] mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                ...
                <div className="lg:col-span-3">
                  <Suspense
                    fallback={<div className="py-8 text-center text-gray-400">加载中...</div>}
                  >
                    <FundingRateTable />
                  </Suspense>
                </div>
                ...
                <div className="lg:col-span-1">
                  <Suspense
                    fallback={<div className="py-6 text-center text-gray-400">加载中...</div>}
                  >
                    <LogPanel />
                  </Suspense>
                  <Suspense
